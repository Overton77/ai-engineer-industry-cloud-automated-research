---
schema: evidence
relation: claim_protocol_version
qualified_name: evidence.claim_protocol_version
kind: table
---

# evidence.claim_protocol_version

Database table evidence.claim_protocol_version.

## Quick facts

- Kind: `table`
- TypeScript row: `Database["evidence"]["Tables"]["claim_protocol_version"]["Row"]`
- Row-level security: enabled
- Search tokens: `evidence claim_protocol_version evidence.claim_protocol_version claim_id ai_protocol_version_id role_in_claim created_at`
...
| --- | --- | --- | --- | --- | --- |
| 1 | `claim_id` | `uuid` | no | — | — |
| 2 | `ai_protocol_version_id` | `uuid` | no | — | — |
...
| --- | --- | --- |
| `claim_protocol_version_ai_protocol_version_id_fkey` | [`corpus.ai_protocol_version`](../../corpus/tables/ai_protocol_version.md) | `FOREIGN KEY (ai_protocol_version_id) REFERENCES corpus.ai_protocol_version(id) ON DELETE CASCADE` |
| `claim_protocol_version_claim_id_fkey` | [`evidence.claim`](../../evidence/tables/claim.md) | `FOREIGN KEY (claim_id) REFERENCES evidence.claim(id) ON DELETE CASCADE` |
